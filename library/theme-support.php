...
if ( ! function_exists( 'elitedigitalbase_theme_support' ) ) :
function elitedigitalbase_theme_support() {
	// Add language support
	load_theme_textdomain( 'elitedigitalbase', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'elitedigitalbase_theme_support' );
endif;
